...
urlpatterns = patterns('',                       
    ...
    url(r'^youtubeconv/$', login_required(views.YoutubeConvView.as_view()), name='videoch-youtubeconv'),
    url('^subdownload/$', views.DownloadSubView.as_view(), name='videoch-sub-download'),
